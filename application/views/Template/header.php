    ...
    -->
			...
			<div class="sidebar-wrapper" id="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="pil <?php
						if($this->uri->segment(1) == 'Nota'){
							echo "active";
						}	
					?>">
						<a href="<?= base_url(); ?>Nota/index/0">
					...
					<li class="<?php
						if($this->uri->segment(1) == 'Rencana'){
							echo "active";
						}	
					?>">
						<a href="<?= base_url(); ?>Rencana">
							<i class="now-ui-icons ui-1_bell-53"></i>
							<p>Surat rencana</p>
						</a>
					</li>
					<li class="<?php
						if($this->uri->segment(1) == 'Jalan'){
							echo "active";
						}	
					?>">
						<a href="<?= base_url(); ?>Jalan/index">
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="#pablo"><?= hari(); ?> | <?= tgl(date('Y-m-d')); ?> | <span
								id="timestamp"> <?= date("H:i:s") ?> </span></a>
					...
					<div class="collapse navbar-collapse justify-content-end" id="navigation">
						<?php if($this->uri->segment(1) != "CHeader" && $this->uri->segment(1) != "Dashboard"): ?>
						<form action="<?= base_url() ?>CHeader/search/<?= $this->uri->segment(1); ?>" method="GET">
							<div class="input-group no-border">
								<input type="date" value="" class="form-control" data-date=""
									data-date-format="MM DD YYYY" id="search" name="search">
						...
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
									<a class="dropdown-item" href="<?= base_url(); ?>CHeader/profile"
										style="color: #F96332;"><b>Akun</b></a>
				...
				<div class="modal-dialog" role="document" style="font-size: 1.2rem;">
					<div class="modal-content">
						<div class="modal-header">
							...
							<a href="<?php
							echo base_url(). "CHeader/hapusSemuaPrint/".$this->uri->segment(1)."/".$this->uri->segment(3);
						?>" class="badge badge-danger mt-3 ml-5">Hapus semua</a>
							<?php endif; ?>
							...
							<div class="modal-body">
								<table style="width: 100%;" class="text-center">
									...
									<tr>
										...
										<td><a href="<?php
									echo base_url(). 'CHeader/hapusPrint/'.$val[0]['id']."~".$this->uri->segment(1).'/'.$this->uri->segment(3)
