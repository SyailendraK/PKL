...
<div class="content">
		...
		<div class="col-md-12">
			<div class="card" style="border-radius: 20px !important;">
				<div class="card-header">
					<h3 class="text-center wide-full"><?= hello(); ?>, Manager</h3>
				</div>
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="tanggal" aria-describedby="emailHelp"
									placeholder="*Tanggal sekarang" value="<?= tgl(date('Y-m-d')); ?>" name="tanggal">
							</div>
							<div class="form-group">
								<label for="kepada">Kepada :</label>
								<input type="text" class="form-control" id="kepada" placeholder="*Dikirim kepada"
									name="kepada">
							</div>
							<div class="form-group">
	...
	<!-- <div class="row">
		<div class="col-md-12">
			<div class="card" style="border-radius: 20px !important;">
				<div class="card-header">
					<h4 class="text-center">Jumlah surat</h4>
				</div>
				<div class="card-body pt-0">
